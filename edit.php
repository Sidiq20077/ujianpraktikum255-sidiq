<?php
//memasukan file koneksi ke file ini
...
//ubah kedalam bentuk array asosiatif
    ...
    <form action="edit_proses.php" method="POST">
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="integer" name="stock" class="form-control" required value="<?= $show["stock"] ?>">
        </div>
           <div class="mb-3">
            <label for="status" class="form-label">Status</label>
            <select name="status" class="form-select" required value="<?= $show["status"] ?>">
